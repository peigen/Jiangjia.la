 ...
 *
 */
public class OkbuyParse extends ParseBase {
	
	private static Document					doc			= null;
	private final static TrackCategoryEnum	category	= TrackCategoryEnum.OKBUY;
	...
	private static void setProductPic(ProductInfo productInfo) {
		...
		Elements elements = doc.select("p.pBigPic > img");
		
		for (Element _element : elements) {
			String url = _element.attr("src").toString();
